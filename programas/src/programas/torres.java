...
public class torres extends javax.swing.JFrame {
    ...
    public torres() {
        ...
        this.setLocationRelativeTo(torres.this);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 160, 110));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 160, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 380, 160, -1));
        ...
        jLabel1.setText("PROGRAMA DE TORRES DE HANOI");
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 540, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try{
            Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=98AZgRqUMK4"));
        }catch(Exception e)
        {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         try{
            Desktop.getDesktop().browse(new URI("https://github.com/chipa3/programacion3/tree/master/Torres%20de%20hanoi"));
        }catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,"NO SE PUDO CONECTAR CON LA PAGINA WEB"+e);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      codigo_torres c = new codigo_torres();
      c.show();
      dispose();
