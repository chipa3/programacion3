 ...
 * @author jose lopez
 */
public class codigo_colas extends javax.swing.JFrame {

    /**
     * Creates new form codigo_colas
     */
    public codigo_colas() {
        initComponents();
         this.setTitle("CODIGO LISTAS");
        this.setLocationRelativeTo(codigo_colas.this);
        this.setResizable(false);
        File archivo= new File("C:\\Users\\jose lopez\\Documents\\programas\\codigos\\colas\\Colas.java");
          try {
          ...
          System.err.println("no se abrio bien el archivo"+ex.toString());
            ...
            File archivo1= new File("C:\\Users\\jose lopez\\Documents\\programas\\codigos\\colas\\Inicio.java");
          try {
          ...
          System.err.println("no se abrio bien el archivo"+ex.toString());
            ...
            File archivo2= new File("C:\\Users\\jose lopez\\Documents\\programas\\codigos\\colas\\Libro.java");
          try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(codigo_colas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new codigo_colas().setVisible(true);
            }
        });
    }
